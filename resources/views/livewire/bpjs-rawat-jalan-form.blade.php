        ...
        <div class="" wire:show='showUploadedData' wire:transition.scale.origin.top.duration.300ms>
            ...
            <div wire:submit.prevent="submit" wire:target="submit" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6" wire:show='patientValidated'>
                        <div>
                            <flux:input name="medical_record_number" label="Nomor RM SEP" type="text"
                                wire:model="medical_record_number" icon:trailing="{{ $rmIcon }}"
                                placeholder="Nomor RM" />
                        </div>
                        <div class="md:col-span-2">
                            <flux:input type="text" variant="filled" icon="user"
                                wire:model.debounce.500ms="patient_name" readonly class="cursor-not-allowed"
                                label="Nama Pasien SEP" placeholder="Terisi Otomatis" />
                        </div>
                        <div>
                ...
                <div wire:show='confirmPatient' wire:transition.scale.origin.top.duration.300ms
                    class="max-w-4xl mx-auto p-6 bg-gray-700 text-gray-100 rounded-xl shadow-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-4">
                        ...
                        <div>
                            <flux:field>
                                <flux:label>
                                    <flux:icon.document-text variant="solid" class="dark:text-pink-400 mr-1.5" /> File
                                    Awal
                                    Medis IGD
                                </flux:label>
                    ...
                    <!-- Form Actions -->
                    <div class="flex md:flex-row justify-end items-right mt-10 gap-4">
